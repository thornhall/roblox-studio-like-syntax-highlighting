...
Now, class methods will be italicized as well as parameters. Roblox defaultLibrary functions will be more reliably displayed as the correct color. Also, the contrast was toned down a bit to make the extension easier on the eyes. 
